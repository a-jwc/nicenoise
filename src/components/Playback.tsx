...
export default function Playback(soundInfo: Sound) {
	return (
		<div className="flex flex-col lg:flex-row object-contain m-auto p-6 text-white w-[33vw] min-w-fit lg:items-center items-start drop-shadow-2xl bg-white bg-opacity-10">
			<audio
				controls
