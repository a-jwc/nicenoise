...
export default function Dropdown({
	...
	return (
		<Menu as="div" className="relative inline-block text-left">
			...
			>
				<Menu.Items className=" origin-top-right bg-white absolute right-0 mt-2 w-56 shadow-lg backdrop-blur-sm ring-1 ring-black ring-opacity-5 focus:outline-none text-black">
					<div className="py-1">
						{/* <Menu.Item>
							{({ active }) => (
